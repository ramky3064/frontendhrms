  ...
  return (
    <Box sx={styles.outerWrapper}>
      ...
      <Dialog
        ...
        PaperProps={{
          sx: { backgroundColor: "#F5E8D3", borderRadius: 2, width: "100%", maxWidth: 500 },
        }}
        ref={modalRef}
      >
        <DialogTitle sx={{ color: "#34495E", fontWeight: 600, fontSize: "19px" }}>
          Add New Holidays
        </DialogTitle>
        <DialogContent>
          ...
          {newHolidays.length > 0 && (
            <Box sx={{ mt: 2 }}>
              ...
              >
                <Typography sx={{ color: "#34495E", fontSize: "16px", fontWeight: 500 }}>
